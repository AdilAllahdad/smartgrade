    ...
    return (
        <DashboardLayout allowedRoles={['guardian']}>
            <div className="container mx-auto px-4 py-4">
                <h1 className="text-2xl font-bold mb-8">Guardian Dashboard</h1>
                
                {/* Student Information Card */}
                {studentInfo && (
                    <div className="bg-white shadow-md rounded-lg p-6 mb-8">
                        <h2 className="text-lg font-semibold border-b pb-2 mb-4">Student Information</h2>
                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    <h2 className="text-lg font-semibold border-b pb-2 mb-4">Examination Results</h2>
                    
                    {results.length === 0 ? (
                        <p className="text-gray-500 text-center py-4">No examination results available yet.</p>
                    ) : (
